...
# Our `.rspec` file contains `--require rails_helper` which will indirectly cause
# this file to always be loaded, without a need to explicitly require it in any
# files.
#
# TODO(chandler37): speed up the tests slightly by requiring rails_helper only
# where needed and using just this file everywhere else.
#
...
ENV.delete("ALGOLIA_APPLICATION_ID")
ENV.delete("ALGOLIA_API_KEY")
